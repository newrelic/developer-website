...
For this task, you could create a New Relic application, using React, the New Relic app software development kit, and the limitless power of modern web technologies.
...
The New Relic software development kit (SDK) allows you to create, serve, publish, and deploy applications to New Relic. It also provides a host of React components for gathering data, presenting information, handling user interactions, and more. You use components like `Button` and `Dropdown` to create an interactive experience that looks and feels native to New Relic. You use `Table` and `Chart` components to display data from your New Relic account or elsewhere. When building your A/B test application, you'd use the SDK's `NrqlQuery` component to fetch Browser data from your account.
