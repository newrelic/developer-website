...
Time for your first NerdGraph query! Erase everything in the query editor and select the following fields in the query explorer in this order: `actor`, `user`, `name`. This GraphQL snippet appears in the editor:
