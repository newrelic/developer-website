...
If you're not happy with your visualization, you can delete it from your dashboard.
...
If you want to edit your visualization after it's been added to a dashboard, you can still edit it from the widget options.

<Steps>

<Step>

Click the ellipses button in the right-hand corner of the visualization, and click **Edit**:

![Edit your visualization](../../images/custom-viz/edit-radar-viz.png)

</Step>

<Step>

Update your visualization in the modal, and click **Save**:

![Confirm](../../images/custom-viz/confirm-edit-radar-viz.png)

</Step>

<Step>

See your updated widget:

![Updated widget](../../images/custom-viz/complete-widget-update.png)
...
This lesson is part of a course that teaches you how to build a custom visualization in the New Relic One platform. Congratulations on making it to the end!
