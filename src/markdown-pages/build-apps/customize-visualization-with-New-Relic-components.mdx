...
In this first set of steps you'll add component state to your visualization template form the previous guide referrenced above. 

<Steps>

  <Step>

From the root of the Nerdpack project you created in the previous guide, navigate to `/visualizations/<your-visualization>/index.js`. You'll continue to work in the `index.js` file for the rest of this guide. Add a chart types constant above the first line of the class. 
