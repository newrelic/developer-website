...
This lesson is part of a course that teaches you how to build a custom visualization in the New Relic One platform. When you're ready, continue on to the next lesson: [_Customize visualizations with configuration_](/build-apps/customize-visualizations-with-configuration).
