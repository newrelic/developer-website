...
New Relic apps use [semantic versioning](https://semver.org) and, under this convention, `1.0.0` signals the first major release. Now, you're ready to publish!

</Step>

<Step>

Replace all instances of `<YOUR NEW RELIC ACCOUNT ID>` and `<YOUR NEW RELIC ENTITY GUID>` in your project with your actual New Relic [account ID](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id) and entity GUID, respectively.
...
From the homepage, navigate to **Add data** in the top navigation bar:
...
![Your app in catalog](../../../images/ab-test/app-in-catalog.png)
...
![Your app with metadata](../../../images/ab-test/app-in-catalog.png)
