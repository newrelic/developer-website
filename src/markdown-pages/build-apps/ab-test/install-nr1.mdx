---
title: 'Install and configure the New Relic app CLI'
template: 'GuideTemplate'
description: 'Install and configure the New Relic app CLI'
---
...
One of the primary elements of the New Relic app SDK is the command line interface (CLI). To create a Nerdpack , you'll need to install the SDK, configure the CLI to work with your New Relic account, and then utilize its `create` command.
...
Now, you can exit the **Build on New Relic** quick start. You’re ready to build an application with the New Relic app CLI!
