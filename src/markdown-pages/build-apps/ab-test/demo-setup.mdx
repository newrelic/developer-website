...
This lesson is part of a course that teaches you how to build a New Relic application from the ground up. Continue on to the next lesson: [_Install and configure the New Relic app CLI_](/build-apps/ab-test/install-nr1).
