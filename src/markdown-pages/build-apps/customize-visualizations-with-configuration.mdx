...
Each lesson in the course builds upon the last, so make sure you've completed the last lesson, [_Custom visualizations and the New Relic app SDK_](/build-apps/custom-visualizations-and-the-new-relic-one-sdk), before starting this one.
