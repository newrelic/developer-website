...
This guide requires that you have an API key and the New Relic app CLI as described in [Set up your development environment](/build-apps/set-up-dev-env).
...
Use the New Relic app CLI to update the application UUID and run the application locally.
