...
After adding a screenshot into each directory, click your nerdpack to see the changes.

![What's Inside Tab](../../../images/build-an-app/whats-inside-nerdlet-tab.png)
