...
You can only publish a package version to the catalog one time. For example, you can't publish two instances of version _1.0.0_. So, each time you want to deploy a new version of your code, you need to increment its version in the Nerdpack's _package.json_ file:
...
![Navigate to the Apps page](../../../images/serve-publish-subscribe/nav-to-io.png)
