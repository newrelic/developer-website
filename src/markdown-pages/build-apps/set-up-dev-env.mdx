...
## Install node.js to run React components

New Relic applications&mdash;and this developer site&mdash;are built on a framework of React components, JavaScript for building user interfaces. You can test out this site or the apps you build locally by installing Node.js and running appropriate `npm` commands. 

- Install the appropriate version of [Node.js](https://nodejs.org/en/download/) for your operating system.
