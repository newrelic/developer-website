...
Starting with version 2.49.1 of our `nr1` CLI, you can build New Relic One applications and custom visualizations with [React hooks](https://reactjs.org/docs/hooks-intro.html). This guide gives some Nerlet examples of React hooks in action!
...
- Create a local New Relic One Nerdpack
