...
```js fileName=.extended-webpackrc.js
```
...
To show your data in a table chart, import the [`TableChart` component](/client-side-sdk/index.html#charts/TableChart) from New Relic. To do so, in `index.js`, add this code under `import React`.
