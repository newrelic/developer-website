...
We strive to write clear messages so you know when and how you need to change your code to address deprecated features.

However, it may still be valuable for you to reach out to our community channels if you need further assistance.

## Get help from the New Relic community

Our global support team doesn't officially support Nerdpacks. That said, if you still need help, you can:
