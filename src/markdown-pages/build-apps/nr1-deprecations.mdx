---
title: 'Manage New Relic app SDK deprecations'
template: 'GuideTemplate'
description: 'Learn how to manage New Relic app SDK deprecations'
---

We frequently update the New Relic app SDK. These updates include new features, improvements to existing features, and the deprecation, or removal, of existing features. When we remove a feature, you, as a developer of New Relic Nerdpacks, need to know because if you don't update your code, it will eventually stop working.
...
When we deprecate features in the New Relic app SDK, we notify you on a predictable schedule so you know what changes will affect your Nerdpack well before they actually do.
...
If you already have the New Relic app CLI, make sure you have the latest version.
