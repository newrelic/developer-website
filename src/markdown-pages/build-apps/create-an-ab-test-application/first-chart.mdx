...
Change to the _add-your-first-chart/_ directory of the course repository:
...
In _nerdlets/ab-test-nerdlet/_, add a new Javascript file named _newsletter-signups.js_:
