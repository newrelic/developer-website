...
The first step in the quick start guide is to select or create a User key. You use this key to associate your New Relic account with the CLI. The CLI then uses the key to manage entities within your account.
