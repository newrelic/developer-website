...
Change to the _add-nerdstoragevault/_ directory of the course repository:
...
In _nerdlets/ab-test-nerdlet/_, add a new Javascript file named _token-prompt.js_:
