...
Change to the _add-nerdstoragevault_ directory of the coursework repository:
...
```js fileName=nerdlets/ab-test-nerdlet/index.js lineHighlight=2-7,29,32-60
import React from 'react';
import {
    ChartGroup,
    Grid,
...
```js fileName=nerdlets/ab-test-nerdlet/index.js lineHighlight=7,74-109
import React from 'react';
import {
    ChartGroup,
    Grid,
...
In _nerdlets/ab-test-nerdlet_, add a new Javascript file named _token-prompt.js_:
...
```js fileName=nerdlets/ab-test-nerdlet/token-prompt.js
import React from 'react';
...
```js fileName=nerdlets/ab-test-nerdlet/token-prompt.js lineHighlight=2-6,20-76
import React from 'react';
import {
    Button,
    Modal,
...
```js fileName=nerdlets/ab-test-nerdlet/token-prompt.js lineHighlight=78
import React from 'react';
import {
    Button,
    Modal,
...
In your Nerdlet's _index.js_ file, import `ApiTokenButton` and `ApiTokenPrompt` and add them to `render()`:

```js fileName=nerdlets/ab-test-nerdlet/index.js lineHighlight=17,114-119,162-164
import React from 'react';
import {
    ChartGroup,
    Grid,
...
Navigate to the root of your Nerdpack at _nru-programmability-course/add-nerdstoragevault/ab-test_.
...
In _index.js_, pass the API token to `TotalCancellations` so you're prepared to make a request to the third-party service:

```js fileName=nerdlets/ab-test-nerdlet/index.js lineHighlight=137-139
import React from 'react';
import {
    ChartGroup,
    Grid,
...
In _total-cancellations.js_, log the token to your browser console:

```js fileName=nerdlets/ab-test-nerdlet/total-cancellations.js lineHighlight=5-11,13-18
import React from 'react';
