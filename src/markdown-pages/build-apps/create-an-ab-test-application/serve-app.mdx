...
Notice the appended query parameter `nerdpacks=local`. This query parameter tells New Relic One to include locally served Nerdpacks.

<Callout variant="tip">

If you don't see your application on the New Relic One platform, make sure you've included `nerdpacks=local` in your querystring!
...
Navigate to the provided url. From the home page, select _Apps_ to view New Relic One applications:
...
Under the _Your apps_ section, find your launcher, called "A/B Test Launcher":
...
Select your launcher and see the default welcome message:
...
New Relic One automatically refreshes your application to show the new heading:
