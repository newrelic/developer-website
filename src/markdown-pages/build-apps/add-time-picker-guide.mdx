...
To develop projects, you need our New Relic app CLI (command line interface). If you haven't already installed it, do the following:
...
This step requires you to import the `timeRangeToNrql` utility method from the New Relic community library.
