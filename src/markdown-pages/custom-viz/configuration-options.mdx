...
- `schemaType`: Nerdpack nerdpack items all have `nr1.json` metadata files. The `schemaType` describes the nerdpack item's schema. For all visualizations, `schemaType` is `VISUALIZATION`.
...
![Account ID property](../../images/custom-viz/account-id-prop.png)
