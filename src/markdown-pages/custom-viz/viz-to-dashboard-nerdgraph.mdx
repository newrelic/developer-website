...
Make sure you replace `<YOUR-USER-KEY>` with the user key you copied in the last step and `<YOUR-ACCOUNT-ID>` with your actual account ID.
...
Make sure you replace `<YOUR-ACCOUNT-ID>` with your actual account ID.
