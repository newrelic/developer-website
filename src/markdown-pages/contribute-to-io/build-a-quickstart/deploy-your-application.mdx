---
path: '/contribute-to-io/build-a-quickstart/deploy-your-application'
...
This procedure is a part of lab that teaches you how to build a quickstart. If you haven't already, check out the [_lab introduction_](/contribute-to-io/build-a-quickstart).
...
This procedure is a part of lab that teaches you how to build a quickstart. Continue on to next lesson: [_Create a dashboard_](/contribute-to-io/build-a-quickstart/create-a-dashboard).
