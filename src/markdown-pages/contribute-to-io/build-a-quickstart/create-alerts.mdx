---
path: '/contribute-to-io/build-a-quickstart/create-alerts'
title: 'Create alerts'
...
This procedure is a part of a lab that teaches you how to build a quickstart. If you haven't already, checkout the [_lab introduction_](/contribute-to-io/build-a-quickstart)

Each procedure in this lab builds on top of the last one, so make sure you [_Create a dashboard_](/contribute-to-io/build-a-quickstart/create-a-dashboard) before proceeding with this one.
...
![new alert policy](../../../images/contribute-to-io/alerts-main.png)

Name your policy FlashDB alert policy. Use the default values for the rest of the fields and click **Create alert policy**.

![create an alert policy](../../../images/contribute-to-io/create-alert-policy.png)
...
![create alert condition](../../../images/contribute-to-io/create-alert-condition.png)
...
![alert condition using nrql](../../../images/contribute-to-io/create-alert-condition-nrql.png)
...
![slow read response nrql](../../../images/contribute-to-io/slow-read-response-nrql.png)
...
![slow read response critical threshold](../../../images/contribute-to-io/critical-threshold.png)
...
![add warning threshold](../../../images/contribute-to-io/add-warning-threshold.png)
...
![slow read response warning threshold](../../../images/contribute-to-io/warning-threshold.png)

Now, You can see your new condition under your FlashDB alert policy. 

![flashdb slow response alert](../../../images/contribute-to-io/flashdb-alert-slow-response.png)
...
![add alert condition using nrql](../../../images/contribute-to-io/add-more-alert-conditions-nrql.png)
...
![low cache hit ratio nrql](../../../images/contribute-to-io/low-cache-hit-ratio-nrql.png)
...
![low cache hit ratio threshold](../../../images/contribute-to-io/low-cache-hit-ratio-threshold.png)

Save the condition to add it to your alert policy which now looks like the following.

![alert policy conditions](../../../images/contribute-to-io/alert-conditions.png)
...
![add notification channel](../../../images/contribute-to-io/add-notification-channel.png)

From the list of channel options, click Email.

![email notification channel](../../../images/contribute-to-io/email-notification-channel.png)

Select the email you want to receive your notifications on, and click **Update policy**.

![update policy](../../../images/contribute-to-io/update-policy.png)
