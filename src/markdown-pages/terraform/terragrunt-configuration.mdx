...
If you haven't done the previous developer guides, you can copy the configurations for this section from the [Terragraunt Intro Github Repo](https://github.com/jsbnr/nr-terragrunt-intro-example).
