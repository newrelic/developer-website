...
description: 'Learn how to use [Terraform](https://www.terraform.io/) modules in your configurations and store them remotely.'
tileShorthand:
  title: 'Using Terraform modules'
  description: 'Learn how to use Terraform modules in your configurations'
resources:
...
Next, in the resource block and in the varaable in main.tf, replace the existing policyId with the new variable:
```hcl
var.policy
```
