...
To manage your Nerdpack subscriptions, use the commands below. You can click any command to see its usage and options, among other details.
...
| Command | Description |
|---|---|
| [`nr1 subscription:set`](#nr1-subscription-set) | Subscribes your account to a Nerdpack and channel. |
| [`nr1 subscription:list`](#nr1-subscription-list) | Lists all the Nerdpacks your account is subscribed to. |
| [`nr1 subscription:unset`](#nr1-subscription-unset) | Unsubscribes your account from a Nerdpack. |
