...
| Command | Description |
|---|---|
| [`nr1 nerdpack:clone`](#nr1-nerdpack-clone)     | Clones a Nerdpack from a git repository. |
| [`nr1 nerdpack:serve`](#nr1-nerdpack-serve)     | Serves your Nerdpack for testing and development purposes. |
| [`nr1 nerdpack:uuid`](#nr1-nerdpack-uuid)       | Shows or regenerates the UUID of a Nerdpack.  |
| [`nr1 nerdpack:publish`](#nr1-nerdpack-publish) | Publishes your Nerdpack to New Relic. |
| [`nr1 nerdpack:deploy`](#nr1-nerdpack-deploy)   | Deploys a specific Nerdpack version to a specific channel. |
