...
To manage your New Relic One Catalog, use the commands below. You can click any command to see its usage options and additional details about the command.
...
Shows the information about your application that's displayed in the New Relic One Catalog.
