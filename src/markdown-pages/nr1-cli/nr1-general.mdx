---
path: '/explore-docs/nr1-general'
title: 'New Relic One CLI general commands'
template: 'GuideTemplate'
description: 'An overview of some general commands you can use with the New Relic One CLI.'
tileShorthand:
  title: 'New Relic One general commands'
  description: 'A few commands to get you started with the New Relic One CLI.'
redirects:
---

<Intro>

Here are a few commands to get you started with the New Relic One CLI. You can click any command to see its usage options and additional details about the command. 
...
| [`nr1 create`](#nr1-create)             | Creates a new component from a template list (Nerdpack, Nerdlet, launcher, or catalog). |
...
Creates a new component from our template list (either a Nerdpack, Nerdlet, launcher, or catalog). The CLI will walk you through this process.
