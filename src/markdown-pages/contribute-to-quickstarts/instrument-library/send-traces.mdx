...
description: 'With our Trace API you can send data from your library or platform.'
tags:
  - quickstart
---
...
Each procedure in this course builds on top of the last one, so make sure you've completed the last procedure, [_send logs from your product_](/contribute-to-quickstarts/instrument-library/send-logs) before proceeding with this one.
...
New Relic, provides you a variety of ways to instrument your application to send traces to our [Trace API](https://docs.newrelic.com/docs/distributed-tracing/trace-api/introduction-trace-api/). 
...
Change to the _send-traces/flashDB_ direcrory of the [course repository](https://github.com/newrelic-experimental/build-a-quickstart-lab).
...
Open _db.py_ file in the IDE of your choice and configure the `SpanClient`.
...
This example expect an environment variable called `$NEW_RELIC_LICENSE_KEY`.
...
Navigate to the root of your application at _build-a-quickstart-lab/send-traces/flashDB_.
...
- **Existing Zipkin instrumentation**: if you have an existing Zipkin implementation, you can simply change the endpoint to New Relic to report your data. Read our documentation to [report data from existing Zipkin instrumentation](https://docs.newrelic.com/docs/distributed-tracing/trace-api/report-zipkin-format-traces-trace-api#existing-zipkin). 
- **Manual Implementation**: If the previous options don’t fit your requirements, you can always manually instrument your own library to make a POST request to the [New Relic Trace API](https://docs.newrelic.com/docs/distributed-tracing/trace-api/report-new-relic-format-traces-trace-api). 

Your platform is now reporting data to New Relic. Next, you observe this data in New Relic using dashboard.

<Callout variant='course'>

This procedure is a part of course that teaches you how to build a quickstart. Continue to next lesson, [_create a dashboard_](/contribute-to-quickstarts/create-a-dashboard).
