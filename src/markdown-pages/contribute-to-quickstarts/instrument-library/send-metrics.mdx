...
- GaugeMetric: It sends a single value at a single point in time.
- CountMetric: It tracks the total number of occurrences of an event.
- SummaryMetric: It tracks count, sum, min, and max values over time.
