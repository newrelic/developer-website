...
description: 'Quickstarts course'
---
...
You recently learnt about New Relic Instant Observability (I/O) which equips you with observability building blocks to get value from your data faster.    
...
New Relic Instant Observability (I/O) is a unified ecosystem of out-of-the-box observability resources that help you get immediate value from your data. It allows you to instrument, monitor, and analyze your technology stack while avoiding the burden of manual setup. 
...
This procedure is a part of course that teaches you how to build a quickstart. Before you start building a quickstart, [_set up your environment_](/contribute-to-quickstarts/deploy-your-application).
