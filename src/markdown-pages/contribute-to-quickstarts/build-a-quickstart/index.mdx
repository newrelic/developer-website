...
This procedure is a part of course that teaches you how to build quickstart. Continue on to next lesson: [_Understand quickstart directory structure_](/contribute-to-quickstarts/build-a-quickstart/understand-quickstart)
