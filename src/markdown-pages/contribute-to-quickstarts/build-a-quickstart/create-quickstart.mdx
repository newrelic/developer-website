...
To remove any unecessary data from your dashboard run the [dashboard sanitize script](https://github.com/newrelic/newrelic-quickstarts/blob/main/CONTRIBUTING.md#dashboard-json) to clean up your dashboard JSON.

<Callout variant="tip">

When creating your dashboard for your quickstart: do not include `permissions: PUBLIC_READ_WRITE` and set all `linkedEntityGuids` to `null` and `accountId` to `0`.
