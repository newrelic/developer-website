...
You are going to start experimenting with tables, but first you need a New Relic One application you can modify and test locally. There's a demo application for you in the [nr1-how-to](https://github.com/newrelic/nr1-how-to) repository.
...
and edit the `index.json` file and set `this.accountId` to [your Account ID](https://docs.newrelic.com/docs/accounts/install-new-relic/account-setup/account-id) as shown in the example.
