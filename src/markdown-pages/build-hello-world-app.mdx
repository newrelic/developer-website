...
Press the down arrow and select `nerdpack` as the component:
...
Type a name for your project, such as `my_nerdpack`:

  ```
  Name your component. ... my_nerdpack
  ```
...
Open up a code editor with this command:
  ...
  > NOTE: Your code editor displays two artifacts: launchers (homepage tile) and nerdlets (contains your code).
