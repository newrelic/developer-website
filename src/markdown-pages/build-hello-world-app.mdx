...
As an optional step, you can add a custom tile icon by dragging and dropping an image icon into the `launcher` artifact.
  <Step>
  ...
  Open a browser and go to `https://one.newrelic.com/?nerdpacks='local' (this url is also shown in the CLI).
