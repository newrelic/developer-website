...
We have a 5-minute video that covers the steps below.
...
The command line interface allows you to run a local version of New Relic One. You can develop your application locally before you publish it in New Relic One.
...
<Steps>
  ...
  In your terminal, if you haven't already done so, change to the new directory named after your nerdpack project. For example, the command might look like this:
  ...
  Open a code editor and point it to your new directory.
  ...
  Change the default `return` message to `"Hello World!"` (or anything else interesting):
...
<Steps>
  ...
  When your new application opens, you see that it needs descriptive information. The next section shows you how to add descriptive metadata.
...
<Steps>
  ...
  If you're not already displaying your application's description page in the browser, click the launcher for the application in the catalog.
...
Now that you completed the steps in this example, you know more about how the basic steps for creating a custom application: 

* Create a local application.
* When you want to begin the process of sharing the application with your colleagues, publish it to the New Relic One catalog.
* Add details to the project in the catalog so users understand how to use it.
* Subscribe accounts to your application so other users can see it directly on the homepage.
