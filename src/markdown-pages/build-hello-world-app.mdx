...
Use your New Relic account credentials to log into our [installation wizard](https://one.newrelic.com/launcher/developer-center.launcher?pane=eyJuZXJkbGV0SWQiOiJkZXZlbG9wZXItY2VudGVyLmRldmVsb3Blci1jZW50ZXIifQ==). It sets you up with the following:
...
Here's how to create a local version of "Hello, World!":

<Steps>

  <Step>

  In your terminal, if you haven't already done so, change to the new directory named after your nerdpack project. For example, the command could look like this:
...
<Steps>
  ...
  When your new application opens, it doesn't display any descriptive information. The next section shows you how to add descriptive metadata.
