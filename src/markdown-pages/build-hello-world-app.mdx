...
Here's how you can quickly build a "Hello, World!" application in New Relic One. In these steps, we'll show you how to create a local version of the New Relic One site where you can prototype your application. Then, when you are ready, you can publish your code to New Relic One.
...
The command line inteface allows you to run a local version of New Relic One. You can develop your application locally before you publish it in New Relic One.
...
<Steps>
  ...
  If you haven't already done so in your terminal, change to the new directory named after your nerdpack project. For example, the command might look like this:
