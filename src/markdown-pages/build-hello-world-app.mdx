...
After you create a local application, you want to share it with others in your organization. 
...
Execute the following in your terminal to make your new application visible in the New Relic One catalog:
...
When your new application opens up, you see that it doesn't have any details. The next section shows you how to add those.
...
Inside your project, execute the following, and when you are prompted, select ***catalog***:

<Important>This creates a stub in your project under the `catalog` directory.</Important>
...
In the `catalog` directory, add screenshots or various types of metadata to describe your project. For details about what you can add, see [Add catalog metadata and screenshots]9https://docs.newrelic.com/docs/new-relic-one/use-new-relic-one/build-new-relic-one/discover-manage-applications-new-relic-one-catalog#clamshell-2).
...
Return to the catalog and refresh the page to see your new screenshots and metadata.
...
To get other users to use your application, you need to subscribe an account to the application. Any user with the NerdPack Manager role can subscribe an account to an application.

<Steps>
  
  <Step>

If you're not already displaying the description page for your application, just click the launcher for it in the catalog.

  </Step>

  <Step>

Select ***Add this app*** on your applications Description page.
