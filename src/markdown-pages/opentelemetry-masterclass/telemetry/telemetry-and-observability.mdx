...
Each lesson in this lab builds on the last one, so make sure you learn about [traces](/opentelemetry-masterclass/telemetry/traces) before proceeding with this one.
...
This lesson is a part of our OpenTelemetry masterclass. Continue on to the next lesson: [Traditional telemetry instrumentation](/opentelemetry-masterclass/telemetry/traditional-telemetry-instrumentation).
