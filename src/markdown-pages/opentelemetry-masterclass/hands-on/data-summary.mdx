...
Also, check your code against [ours](https://github.com/newrelic-experimental/mcv3-apps/tree/main/Instrumented) to make sure you correctly instrumented your application.
</Callout>

Select **Services-OpenTelemetry** from the left-hand navigation, then choose the one with the service name you specified when you instrumented your application:
