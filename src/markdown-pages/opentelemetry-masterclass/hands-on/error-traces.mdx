...
To see more information about your in-process span, expand the root span, toggle **Display in-process spans for this service**, and click your in-process span:
