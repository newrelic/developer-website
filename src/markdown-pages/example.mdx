...
<Step title="Clone the example application">
...
<Step title="Set up and run the application locally">
...
<Step title="Make sure you're getting data from the right New Relic account">
