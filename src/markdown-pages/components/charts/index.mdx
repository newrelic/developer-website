...
resources:
  - title: New Relic VSCode extension
...
In your application, you can display data in charts, like those used elsewhere in New Relic's user interface. The New Relic app SDK provides React components for different chart types.
