...
- A launcher is not required; as an alternative to using a launcher, you can [associate your application with a monitored entity](https://developer.newrelic.com/build-apps/attach-nerdlet-to-entities).
