...
A [New Relic One application](https://developer.newrelic.com/use-cases/build-new-relic-one-applications 'Link opens in a new window.') is represented by a **Nerdpack** folder, which can include one or more **Nerdlet** files,
