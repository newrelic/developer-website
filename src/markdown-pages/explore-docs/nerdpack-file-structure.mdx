...
- **Generate Nerdlet or launcher individually**: Use the [New Relic One CLI](/nr1-cli) command `nr1 create` and choose either a Nerdlet or a launcher. This can be useful when adding Nerdlets to an existing Nerdpack.
...
The icon displayed on the launcher for the app on the **Apos** page.
