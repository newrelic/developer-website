...
Using the `name` field for every configuration object in your visualization's _nr1.json_ file, build a `rawConfiguration` for your widget:
...
[Look up your account ID](https://docs.newrelic.com/docs/accounts/accounts-billing/account-setup/account-id/) and enter it for your `accountId`:
...
[Look up your dashboard's GUID](https://docs.newrelic.com/docs/new-relic-one/use-new-relic-one/core-concepts/what-entity-new-relic/#find) and enter it for `guid`:
...
![Select API key](../../../images/custom-viz/nerdgraph-api-key.png)
...
![Paste your mutation](../../../images/custom-viz/nerdgraph-create-dashboard-with-viz.png)
...
![Execute your query](../../../images/custom-viz/nerdgraph-successful-dashboard-creation.png)
...
![Navigate to Dashboards](../../../images/custom-viz/nav-to-dashboards.png)
...
![Select your dashboard](../../../images/custom-viz/select-dashboard.png)
...
![My Awesome Dashboard](../../../images/custom-viz/my-awesome-dashboard.png)
