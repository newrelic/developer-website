...
| [`nr1 nerdpack:clean`](#nr1-nerdpackclean) | Removes all built nerdpack items |
...
| [`nr1 nerdpack:validate`](#nr1-nerdpackvalidate) | Validates nerdpack items inside your Nerdpack |
...
Removes all built nerdpack items
...
Validates nerdpack items inside your nerdpack
