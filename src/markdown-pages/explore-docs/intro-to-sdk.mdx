---
title: 'Intro to New Relic app SDK'
template: 'GuideTemplate'
description: 'Intro to New Relic app SDK'
tileShorthand:
  title: 'New Relic app component reference'
  description: 'Reference for all New Relic app SDK components'
redirects:
...
To help you build New Relic applications, we provide you with the New Relic app SDK.
