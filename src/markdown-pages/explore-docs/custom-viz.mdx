...
When you create a [dashboard](https://docs.newrelic.com/docs/query-your-data/explore-query-data/dashboards/introduction-dashboards/), you add a variety of charts to visualize your New Relic telemetry data. These charts, offered out-of-the-box, are customizable in that you can:
...
To build your first custom visualization, download the New Relic One SDK and make sure you have the latest version:
...
```sh
nr1 create --type nerdpack --name quickstart
cd quickstart
nr1 create --type visualization --name custom-viz
```

The visualization you created in the `quickstart` Nerdpack contains a default component to help you get started.
...
Enter values into the fields under **Configure visualization properties** to see how the chart changes:
...
- [Visualization files **(Documentation)**](viz-files)
...
If you want to reuse your visualization to include different data or change its presentation, you can go back to **Apps > Custom Visualizations**, choose your visualization, configure another instance and add it to your dashboard:
