...
resources:
    ...
    - title: Custom visualizations and the New Relic app SDK
...
With the New Relic app SDK, we've provided you all the tools you'll need to create your own visualizations.

## Build your custom visualization

With the New Relic app SDK, you can create a Nerdpack, which houses your visualization code. This code consists of a React component, logic, data queries, and external dependencies. The SDK also provides a component library that you can use to make NerdGraph requests, access platform state context, and more.

Check out this video showing how to create a custom visualization (8:14 minutes).

<Video id="Y9poT8LDhGg" type="youtube"/>

### Your first visualization

To build your first custom visualization, [install the New Relic app SDK](/automate-workflows/get-started-new-relic-cli) and make sure you have the latest version:
...
- [Custom visualizations and the New Relic app SDK **(Guide)**](/build-apps/custom-visualizations-and-the-new-relic-one-sdk)
