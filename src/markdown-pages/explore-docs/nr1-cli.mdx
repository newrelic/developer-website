---
title: 'New Relic app CLI reference'
...
To build a [New Relic app](/build-apps/build-hello-world-app), you must install the New Relic app CLI. The CLI helps you build, publish, and manage your New Relic app.

<br />

</Intro>

We provide a variety of tools for building apps, including the New Relic app CLI (command line interface). This page explains how to use [CLI commands](#new-relic-one-cli-commands) to:
...
## Installing the New Relic app CLI
...
## New Relic app CLI commands

This table provides descriptions for the New Relic app CLI commands. For more context, including usage and option details, click any individual command or the command category.
