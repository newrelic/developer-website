...
| [`nr1 nrql`](/explore-docs/nr1-common/#nr1-nrql)                 | Fetches data from New Relic using [NRQL](https://newrelic.com/docs/query-data/nrql-new-relic-query-language/getting-started/introduction-nrql) (New Relic query language). |                                                                                                                                                                                                                                                                                                 |
