...
- Learn about the [infrastructure of Telco Lite](diagnose-problems#welcome-to-acme-telco-lite)
- [Set up your local environment](diagnose-problems#set-up-your-environment)
- [Deploy and instrument the Telco Lite services](diagnose-problems#deploy-telco-lite).
