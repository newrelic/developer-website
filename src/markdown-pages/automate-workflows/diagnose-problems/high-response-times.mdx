...
## Diagnose high response time in Telco Lite
...
Next, drill down the fulfillment service for even more information. 
...
Scroll down on this view to familiarize yourself with the graphs & tables it shows, such as **Throughput**,  **Error rate**, **Hosts**. Next, drill into the host to see what's happening. 

</Step>

<Step>

To drill into the host, switch to the old UI. Toggle **Show new view** to off and select the host link:
...
This procedure is part of a lab that teaches you how to diagnose common issues using New Relic. Continue on to next procedure: [Diagnose error alerts](/automate-workflows/diagnose-problems/error-alerts).
