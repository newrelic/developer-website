---
path: '/automate-workflows/diagnose-problems/view-your-services'
...
This procedure is part of a lab that teaches you how to diagnose common issues using New Relic. Continue on to next procedure: [Diagnose high response time](/automate-workflows/diagnose-problems/high-response-times).
