...
- Use the open-source New Relic [`demo-deployer`](https://github.com/newrelic/demo-deployer) to spin up the infrastructure for Acme Telco Lite, a fictional company, and simulate real-world issues in a controlled, demo environment
...
When you're finished diagnosing all the issues effecting Telco Lite, follow the [Teardown guide](https://github.com/newrelic/demo-deployer/tree/main/demo/README.md#tear-down-your-resources) in the deployer's repository to tear down the services you created in your cloud provider. If you're still exploring, don't tear down your services, or you'll have to deploy them again later.
