...
Learn more about using New Relic by diagnosing [other issues](https://developer.newrelic.com/automate-workflows/diagnose-problems#view-your-services). If this is your last issue, [tear down](https://developer.newrelic.com/automate-workflows/diagnose-problems#tear-down-telco-lite) all the Telco Lite services.
