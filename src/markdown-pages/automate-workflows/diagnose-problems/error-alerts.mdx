...
duration: '20 min'
title: 'Diagnosing error alerts in Telco Lite'
...
Log in to [New Relic One](one.newrelic.com) and select **APM** from the top navigation menu. Here, you see an overview of all eight Telco Lite services, including the service names, response times, and throughputs. Notice that **Telco-Login Service** and **Telco-Web Portal** have opened critical violations for high error percentages:
...
Right now, you can only select the host's name from the old version of the UI (we're working on it). So, make sure you toggled **Show new view** to "off".
...
![Authentication host, new time slice](../../../images/telco-lite/auth-host-zoomed.png)
