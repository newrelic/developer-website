...
Open the [Kubernetes cluster explorer in New Relic](https://one.newrelic.com/launcher/k8s-cluster-explorer-nerdlet.cluster-explorer-launcher?pane=eyJuZXJkbGV0SWQiOiJrOHMtY2x1c3Rlci1leHBsb3Jlci1uZXJkbGV0Lms4cy1jbHVzdGVyLWxpc3QifQ==)
...
<iframe
  ...
  src="https://play.instruqt.com/embed/newrelic/tracks/nr-k8s-helm?token=em_jmayburfxytzsh6m&show_challenges=true"
  style="border: 0;"
>
