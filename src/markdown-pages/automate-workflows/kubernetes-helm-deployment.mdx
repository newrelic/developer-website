...
tileShorthand:
  title: 'Set up New Relic using Helm chats'
...
This walkthrough assumes you’ve already deployed a Kubernetes cluster. Or simply use our test environment, by following the interactive tutorial at the bottom of this page.
...
![Launcher artifact with icon.png](../../images/kubernetes-helm-deployment/k8s-cluster-explorer.png)
...
We have a Kubernetes test cluster ready for you in 2 minutes. By following this on-line tutorial, you will learn how to deploy the New Relic Helm charts.
