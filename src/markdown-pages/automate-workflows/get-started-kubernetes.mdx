...
[Kubernetes](https://kubernetes.io/) is an open-source system for automating deployment, scaling, and management of containerized applications. You can use it to provision all kind of infrastructure and services, including New Relic entities.

In this guide you'll learn how to set up New Relic for the first time with the official [New Relic Kubernetes operator](https://github.com/newrelic/newrelic-kubernetes-operator). More specifically, you are going to provision an alert policy with NRQL conditions in your New Relic account using Kubernetes.
...
Now that you’ve created an alert policy in the previous section, you’ll want to add some alert conditions to the policy so you can trigger alerts when certain metrics are out of line.
...
<em><small><strong>Note</strong>: To receive notifications when an alert is triggered, you'll want to add <a href="https://docs.newrelic.com/docs/alerts/new-relic-alerts/managing-notification-channels/notification-channels-control-where-send-alerts">notification channels</a> to your alert policy.</small></em>
...
To finish things off, you'll want to create and add an alert channel to your alert policy. For example, maybe you want to send an email out to your team when your alert condition is triggered.
</Step>
<Step>
...
As you and your team move forward, you may need to adjust some of the configuration values to better fit your needs.
