...
<small><em><strong>Note</strong>: For help locating your personal API key, check out our <a href="https://docs.newrelic.com/docs/apis/get-started/intro-apis/types-new-relic-api-keys#">personal API key documentation</a>.</em></small>
...
The New Relic Kubernetes Operator is just one of several tools in our Developer Toolkit aimed at facilitating observability as code. 
