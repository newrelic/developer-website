...
Values can be deleted at any time by invoking the [`entity tags delete-values`](https://github.com/newrelic/newrelic-cli/blob/main/docs/cli/newrelic_entity_tags_delete-values.md) command followed by the same arguments you used to create them.
