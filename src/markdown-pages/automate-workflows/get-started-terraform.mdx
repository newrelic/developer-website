...
[Terraform](https://www.terraform.io/) is a popular infrastructure as code software tool by HashiCorp. You can use it to provision all kinds of infrastructure and services, including New Relic entities.
