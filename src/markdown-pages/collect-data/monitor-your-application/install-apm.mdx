---
duration: 10
title: 'Instrument your application with APM agent'
template: 'GuideTemplate'
description: 'Instrument your Angular application with Node JS agent'
procIdx: 2
---
...
Your Angular application is running and is getting a lot of traffic. You want to instrument it with New Relic to start monitoring your application. 

Here, you learn how easy it is to instrument your application using our guided install to collect application monitoring data from your application and send it to New Relic so you can analyze it later.
...
This guide you through instrumenting your application with Node JS agent using Package manager.
...
From **Add your Node.js application data** page in New Relic, click **Download**.
...
In _server/index.js_ file, update the code to add New Relic to your application.
...
Your application is now instrumented with Node JS APM agent.
...
Your app is now sending data to New Relic. You view this data in New Relic, under **APM**.
...
Here, you see **Web transaction time**, **Apdex score**, **Throughput** and other critical data related to your app.
...
You've instrumented your application to send application monitoring data to New Relic using our Node JS agent. You also saw your app related data in New Relic. Now, it's time to instrument your application with browser agent.

<Callout variant="course" title="lab">

This procedure is part of a lab that teaches you how to monitor your application with New Relic. Now that you've instrumented your application with APM agent, [Instrument your application with Browser agent](/collect-data/monitor-your-application/install-browser-agent).
