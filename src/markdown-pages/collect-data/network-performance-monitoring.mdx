...
- A full user with the Nerdpack modify user privilege

<Callout variant="caution">

This track utilizes an ephemeral virtual machine. As a result, finish the entire track in one sitting or you'll lose your progress when time expires.

</Callout>

## Lab

<iframe width="1140" height="640" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-modals" src="https://play.instruqt.com/embedv2/newrelic/tracks/network-performance-monitoring?token=em_8vjt8dquoemjh76q" style="border: 0;"></iframe>
