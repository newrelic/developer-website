...
```html lineHighlight=21-22 fileName=public/index.html
<!DOCTYPE html>
<html lang="en">
...
Place a few orders to generate some traffic against your app.
...
Navigate to [New Relic](https://one.newrelic.com/), select **Browser** from the top navigation, and select **Reliqstaurant**.

![Arrow pointing to reliqstaurant app](../../../images/nr-browser/view-reliqstaurant.png)
...
![Browser view of reliqstaurant](../../../images/nr-browser/reliqstaurant-browser-app.png)
