---
path: '/collect-data/query-data-nrql'
duration: 10
title: 'Query data with NRQL'
template: 'GuideTemplate'
description: 'Query default data as well as custom events and attributes with our powerful, SQL-like query language. Start querying now.'
tileShorthand:
  title: 'Query data with NRQL'
  description: 'Query default data, custom events, and attributes'
redirects:
  - /technology/nrql
resources:
  - title: 'NRQL lessons'
