...
Change to the _main_ directory, and run the setup script to spin up a new minikube cluster:
...
This uses the pixie-supported hyperkit driver and configures your network memory and CPU with limits that will work well with this lab. It also deploys your TinyHat application to your cluster.
