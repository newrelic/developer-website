...
In minutes, Pixie was able to instrument your entire cluster without you having to install language-specific agents or specify detailed cluster information!

On top of all the data you see in the cluster explorer, click a pod or a node to dig deeper and see the granular data that Pixie was able to access near-instantly:
