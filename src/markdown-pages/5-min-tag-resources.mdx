---
path: '/guides/5-mins-tag-resources'
duration: '30 min'
title: 'Tag a set of resources in 5 minutes'
...
For this guide you need your New Relic [personal API Key](https://docs.newrelic.com/docs/apis/get-started/intro-apis/types-new-relic-api-keys#personal-api-key): Create it from the **Account settings** of your New Relic account.
...
<Important>Adding tags is an asynchronous operation: it could take a while for the tags to get created.</Important>
...
To make sure that the tags have been added to your entities, retrieve them using the [`entity tags get`](https://github.com/newrelic/newrelic-cli/blob/master/docs/cli/newrelic_entity_tags_get.md) command. All tags associated with your application are retrieved as a JSON array.
